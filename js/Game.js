...
handlePlayerControls() {
  if (keyIsDown(UP_ARROW)) {
    //Coloque a propriedade 'playerMoving' como 'true', pois
    //ela adiciona uma velocidade automaticamente 
    this.playerMoving = ?; 
    player.positionY += 10;
    player.update();
  }
...
showRank() {
  ...
  gameOver() {
    //Crie uma notificação para o fim do jogo
    swal({
      ?: `Fim de Jogo`,
      ?: "Ops, você perdeu a corrida....!!!",
      ?:
